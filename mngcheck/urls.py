...
urlpatterns = [
    ...
    path('reset_password/',
          auth_views.PasswordResetView.as_view(template_name="password_reset_form.html", html_email_template_name='password_reset_email.html'), name='reset_password'),
